...
for ii in range(int(len(filelist)/4)):#range(k0,k0+LengthOfInterval):
...
SaveSharedP = "\SharedP_20210401_100_825_seed10000_new_zpfit_after1850"


checkstart = 1

random.seed(10000)
for i in range(NumOfSeries*1850):
    random.randint(0,LengthOfInterval-1)

for Saves in range(1850,10000):
