...
for Saves in range(0,500):
    ...
    #residLst = np.array(dataLst*(datasigma.reshape((1, NumOfSeries*1000))))
    dataLst = nptp(dataBooted.reshape((NumOfSeries, 1000)))
    
    cv2.imshow("dataLst",np.array(dataLst))
    cv2.waitKey(0)
    ...
    Guessvalueslmfit = [1.4,.0001,352.4,.190+.01+k*.001,.6,5.0]#,3.e-4]
