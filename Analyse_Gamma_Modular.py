            ...
            for Numdata in range(len(chosenfolders)):
                for i in range(len(targetfiles)):
                    if targetfiles[i][0:-4] == listidentifier and len(targetfiles[i][0:-4]) == len(listidentifier):
                        ...
                        with open(DataPath + "//All_Modular//" + chosenfolders[Numdata] + "//" + targetfiles[i],"rt") as csvfile:
...
chosenfolders = [
                "SharedP_20210401_825_825_seed10000_new_zpfit_boot000",
                "SharedP_20210401_825_825_seed10000_new_zpfit_boot400",
                "SharedP_20210401_825_825_seed10000_new_zpfit_boot800",
...
gn0 = cl("gammafitSharedP_20210401_100_000358_825_seed10000_new_zpfit_NoConv*")
gn4 = cl("gammafitSharedP_20210401_100_358716_825_seed10000_new_zpfit_NoConv*")
gn8 = cl("gammafitSharedP_20210401_716_000716_716_seed10000_new_zpfit_NoConv*")
dn0 = cl("delta0fitSharedP_20210401_100_000358_825_seed10000_new_zpfit_NoConv*")
dn4 = cl("delta0fitSharedP_20210401_100_358716_825_seed10000_new_zpfit_NoConv*")
dn8 = cl("delta0fitSharedP_20210401_716_000716_716_seed10000_new_zpfit_NoConv*")
gWL = cl("gammafitSharedP_20210401_825_seed10000_MultiWL_NoConv_444sqrt*")

ld("*Amplfit*")
ld("*Ytran*")
ld("*cfit*")

an0 = cl("AmplfitSharedP_20210401_100_000358_825_seed10000_new_zpfit_NoConv*")
an4 = cl("AmplfitSharedP_20210401_100_358716_825_seed10000_new_zpfit_NoConv*")
yn0 = cl("YtranSharedP_20210401_100_000358_825_seed10000_new_zpfit_NoConv*")
yn4 = cl("YtranSharedP_20210401_100_358716_825_seed10000_new_zpfit_NoConv*")
cn0 = cl("cfitSharedP_20210401_100_000358_825_seed10000_new_zpfit_NoConv*")
cn4 = cl("cfitSharedP_20210401_100_358716_825_seed10000_new_zpfit_NoConv*")
"""