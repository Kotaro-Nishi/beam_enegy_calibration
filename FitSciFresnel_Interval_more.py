...
while k < int(len(filelist)/4)-NumOfSeries:
    ...
    if DoNotSave == 0:
        ...
        #residLst = np.array(residLst*(datasigma.reshape((1, NumOfSeries*1000))))
        ...
        with open(DataPath + "\\SharedP\\zpfit.csv", 'a+', newline='') as write_obj:
            # Create a writer object from csv module
            csv_writer = csv.writer(write_obj)
            # Add contents of list as last row in the csv file
        ...
        with open(DataPath + "\\SharedP\\zpfitstderr.csv", 'a+', newline='') as write_obj:
            # Create a writer object from csv module
            csv_writer = csv.writer(write_obj)
            # Add contents of list as last row in the csv file
        ...
        with open(DataPath + "\\SharedP\\amplzpfitCorrel.csv", 'a+', newline='') as write_obj:
            # Create a writer object from csv module
            csv_writer = csv.writer(write_obj)
            # Add contents of list as last row in the csv file
        ...
        with open(DataPath + "\\SharedP\\YtranzpfitCorrel.csv", 'a+', newline='') as write_obj:
            # Create a writer object from csv module
            csv_writer = csv.writer(write_obj)
            # Add contents of list as last row in the csv file
        ...
        with open(DataPath + "\\SharedP\\gammazpfitCorrel.csv", 'a+', newline='') as write_obj:
            # Create a writer object from csv module
            csv_writer = csv.writer(write_obj)
            # Add contents of list as last row in the csv file
        ...
        with open(DataPath + "\\SharedP\\delta0fitzpfitCorrel.csv", 'a+', newline='') as write_obj:
            # Create a writer object from csv module
            csv_writer = csv.writer(write_obj)
            # Add contents of list as last row in the csv file
            csv_writer.writerow([delta0fitzpfitCorrel])

        with open(DataPath + "\\SharedP\\bfitzpfitCorrel.csv", 'a+', newline='') as write_obj:
            # Create a writer object from csv module
            csv_writer = csv.writer(write_obj)
            # Add contents of list as last row in the csv file
    ...
    #dataLst2D = np.array(residLst*(datasigma.reshape((1, NumOfSeries*1000))))
    dataimg2D = nptp(data.reshape((NumOfSeries, 1000)))
